            ...
            <table className="min-w-full w-full text-sm">
                ...
                {loading ? (
                  ...
                  rows.map((r) => (
                    <tr key={r._id} className="border-t border-slate-100 hover:bg-slate-50 transition">
                      ...
                      {cols.name && <td className="px-4 py-3 text-sm text-slate-700 whitespace-nowrap">{r.businessName || r.name}</td>}
                      ...
                      {cols.openingBalance && (
                        <td className="px-4 py-3 text-sm text-slate-700 whitespace-nowrap">Rs. {money(r.totals?.openingBalanceDue)}</td>
                      )}
                      {cols.advanceBalance && (
                      ...
                      {cols.returnDue && (
                        <td className="px-4 py-3 text-sm text-slate-700 whitespace-nowrap">Rs. {money(r.totals?.totalSaleReturnDue)}</td>
                      )}
              ...
              <tfoot>
                <tr className="border-t border-slate-200 bg-slate-50">
                  ...
                  {cols.returnDue && (
                    <td className="px-4 py-3 font-semibold text-slate-700 whitespace-nowrap">Rs. {money(totals.totalSaleReturnDue)}</td>
                  )}
