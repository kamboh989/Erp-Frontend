    ...
    const next = await CrmSettings.findOneAndUpdate(
      { companyId: session.companyId },
      {
        $set: {
          ...
          autoMoveToContactedOnFirstActivity: Boolean(body.autoMoveToContactedOnFirstActivity),
          metaAssignmentMode: body.metaAssignmentMode === "UNASSIGNED" ? "UNASSIGNED" : "DEFAULT_OWNER",
        },
      },
